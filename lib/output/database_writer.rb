class DatabaseWriter
  ...
  def save(measurement)
    ...
    query = <<-QUERY
      INSERT INTO measurements(time_stamp, stroom_dal, stroom_piek, stroom_current, diff_stroom_dal, diff_stroom_piek, gas) VALUES('#{c.escape measurement.time_stamp.to_s}',
